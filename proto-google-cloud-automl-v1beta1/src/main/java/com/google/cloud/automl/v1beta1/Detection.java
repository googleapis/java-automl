  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          ...
          + "google/protobuf/duration.proto\032\034google/api/annotations.proto\"p\n"
          + "\036ImageObjectDetectionAnnotation\022?\n"
          + "\014bounding_box\030\001 \001(\0132).google.cloud.automl.v1beta1.BoundingPoly\022\r\n"
          + "\005score\030\002 \001(\002\"\264\001\n"
          + "\035VideoObjectTrackingAnnotation\022\023\n"
          + "\013instance_id\030\001 \001(\t\022.\n"
          + "\013time_offset\030\002 \001(\0132\031.google.protobuf.Duration\022?\n"
          + "\014bounding_box\030\003 \001(\0132).google.cloud.automl.v1beta1.BoundingPoly\022\r\n"
          + "\005score\030\004 \001(\002\"\256\002\n"
          + "\027BoundingBoxMetricsEntry\022\025\n\r"
          + "iou_threshold\030\001 \001(\002\022\036\n"
          + "\026mean_average_precision\030\002 \001(\002\022o\n"
          + "\032confidence_metrics_entries\030\003 \003(\0132K.g"
          + "oogle.cloud.automl.v1beta1.BoundingBoxMetricsEntry.ConfidenceMetricsEntry\032k\n"
          ...
          + "%ImageObjectDetectionEvaluationMetrics\022$\n"
          + "\034evaluated_bounding_box_count\030\001 \001(\005\022Z\n"
          + "\034bounding_box_metrics_entries\030\002"
          + " \003(\01324.google.cloud.automl.v1beta1.BoundingBoxMetricsEntry\022+\n"
          + "#bounding_box_mean_average_precision\030\003 \001(\002\"\364\001\n"
          + "$VideoObjectTrackingEvaluationMetrics\022\035\n"
          + "\025evaluated_frame_count\030\001 \001(\005\022$\n"
          + "\034evaluated_bounding_box_count\030\002 \001(\005\022Z\n"
          + "\034bounding_box_metrics_entries\030\004 \003(\01324.google.clo"
          + "ud.automl.v1beta1.BoundingBoxMetricsEntry\022+\n"
          + "#bounding_box_mean_average_precision\030\006 \001(\002B\245\001\n"
          + "\037com.google.cloud.automl.v1beta1P\001ZAgoogle.golang.org/genproto/googlea"
          + "pis/cloud/automl/v1beta1;automl\312\002\033Google"
          + "\\Cloud\\AutoMl\\V1beta1\352\002\036Google::Cloud::AutoML::V1beta1b\006proto3"
    };
    descriptor =
