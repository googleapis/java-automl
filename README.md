...
The Maven artifact coordinates (`com.google.cloud:google-cloud-automl`) remain the same.
...
```Groovy
implementation 'com.google.cloud:google-cloud-automl:2.11.0'
```

If you are using SBT, add this to your dependencies:

```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-automl" % "2.11.0"
```
