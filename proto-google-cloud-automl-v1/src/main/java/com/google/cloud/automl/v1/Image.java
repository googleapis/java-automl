...
public final class Image extends com.google.protobuf.GeneratedMessageV3
    ...
    try {
      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 58:
            {
              com.google.cloud.automl.v1.ImageInputConfig.Builder subBuilder = null;
              if (dataCase_ == 7) {
                subBuilder = ((com.google.cloud.automl.v1.ImageInputConfig) data_).toBuilder();
              }
              data_ =
                  input.readMessage(
                      com.google.cloud.automl.v1.ImageInputConfig.parser(), extensionRegistry);
              if (subBuilder != null) {
                subBuilder.mergeFrom((com.google.cloud.automl.v1.ImageInputConfig) data_);
  ...
  public static final int IMAGE_INPUT_CONFIG_FIELD_NUMBER = 7;
  /**
   *
   *
   * <pre>
   ...
   * </pre>
   *
   * <code>.google.cloud.automl.v1.ImageInputConfig image_input_config = 7;</code>
   */
  public boolean hasImageInputConfig() {
    return dataCase_ == 7;
  }
  /**
   *
   ...
   * <code>.google.cloud.automl.v1.ImageInputConfig image_input_config = 7;</code>
   */
  public com.google.cloud.automl.v1.ImageInputConfig getImageInputConfig() {
    if (dataCase_ == 7) {
      return (com.google.cloud.automl.v1.ImageInputConfig) data_;
    }
   ...
   * <code>.google.cloud.automl.v1.ImageInputConfig image_input_config = 7;</code>
   */
  public com.google.cloud.automl.v1.ImageInputConfigOrBuilder getImageInputConfigOrBuilder() {
    if (dataCase_ == 7) {
      return (com.google.cloud.automl.v1.ImageInputConfig) data_;
    }
    return com.google.cloud.automl.v1.ImageInputConfig.getDefaultInstance();
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    ...
    if (dataCase_ == 7) {
      output.writeMessage(7, (com.google.cloud.automl.v1.ImageInputConfig) data_);
    }
    ...
    if (dataCase_ == 7) {
      size +=
          com.google.protobuf.CodedOutputStream.computeMessageSize(
              7, (com.google.cloud.automl.v1.ImageInputConfig) data_);
    }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    switch (dataCase_) {
      case 1:
        ...
        break;
      case 7:
        if (!getImageInputConfig().equals(other.getImageInputConfig())) return false;
        break;
      case 0:
      default:
    }
  ...
  public int hashCode() {
    ...
    switch (dataCase_) {
      case 1:
        ...
        break;
      case 7:
        hash = (37 * hash) + IMAGE_INPUT_CONFIG_FIELD_NUMBER;
        hash = (53 * hash) + getImageInputConfig().hashCode();
        break;
      case 0:
      default:
    }
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessageV3.Builder<Builder>
    ...
    public com.google.cloud.automl.v1.Image buildPartial() {
      ...
      if (dataCase_ == 7) {
        if (imageInputConfigBuilder_ == null) {
          result.data_ = data_;
        } else {
          result.data_ = imageInputConfigBuilder_.build();
        }
      }
    ...
    public Builder mergeFrom(com.google.cloud.automl.v1.Image other) {
      ...
      switch (other.getDataCase()) {
        ...
        case IMAGE_INPUT_CONFIG:
          {
            mergeImageInputConfig(other.getImageInputConfig());
            break;
          }
        case DATA_NOT_SET:
          {
    ...
    private com.google.protobuf.SingleFieldBuilderV3<
            com.google.cloud.automl.v1.ImageInputConfig,
            com.google.cloud.automl.v1.ImageInputConfig.Builder,
            com.google.cloud.automl.v1.ImageInputConfigOrBuilder>
        imageInputConfigBuilder_;
    /**
     *
     *
     * <pre>
    ...
    public com.google.cloud.automl.v1.ImageInputConfig getImageInputConfig() {
      if (imageInputConfigBuilder_ == null) {
        ...
        if (dataCase_ == 7) {
          return imageInputConfigBuilder_.getMessage();
        }
        return com.google.cloud.automl.v1.ImageInputConfig.getDefaultInstance();
      }
    }
     ...
     * <code>.google.cloud.automl.v1.ImageInputConfig image_input_config = 7;</code>
     */
    public Builder setImageInputConfig(com.google.cloud.automl.v1.ImageInputConfig value) {
      if (imageInputConfigBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
        ...
        imageInputConfigBuilder_.setMessage(value);
      }
      dataCase_ = 7;
      return this;
    }
     ...
     * <code>.google.cloud.automl.v1.ImageInputConfig image_input_config = 7;</code>
     */
    public Builder setImageInputConfig(
        com.google.cloud.automl.v1.ImageInputConfig.Builder builderForValue) {
      if (imageInputConfigBuilder_ == null) {
        data_ = builderForValue.build();
        onChanged();
      } else {
        imageInputConfigBuilder_.setMessage(builderForValue.build());
      }
      dataCase_ = 7;
      return this;
    }
     ...
     * <code>.google.cloud.automl.v1.ImageInputConfig image_input_config = 7;</code>
     */
    public Builder mergeImageInputConfig(com.google.cloud.automl.v1.ImageInputConfig value) {
      if (imageInputConfigBuilder_ == null) {
        if (dataCase_ == 7
            && data_ != com.google.cloud.automl.v1.ImageInputConfig.getDefaultInstance()) {
          data_ =
              com.google.cloud.automl.v1.ImageInputConfig.newBuilder(
                      (com.google.cloud.automl.v1.ImageInputConfig) data_)
                  .mergeFrom(value)
                  .buildPartial();
        } else {
          data_ = value;
        ...
        if (dataCase_ == 7) {
          imageInputConfigBuilder_.mergeFrom(value);
        }
        imageInputConfigBuilder_.setMessage(value);
      }
      dataCase_ = 7;
     ...
     * <code>.google.cloud.automl.v1.ImageInputConfig image_input_config = 7;</code>
     */
    public Builder clearImageInputConfig() {
      if (imageInputConfigBuilder_ == null) {
        if (dataCase_ == 7) {
          dataCase_ = 0;
          data_ = null;
        ...
        imageInputConfigBuilder_.clear();
      }
      return this;
    }
    /**
     ...
     * <code>.google.cloud.automl.v1.ImageInputConfig image_input_config = 7;</code>
     */
    public com.google.cloud.automl.v1.ImageInputConfig.Builder getImageInputConfigBuilder() {
      return getImageInputConfigFieldBuilder().getBuilder();
    }
    /**
     *
     *
     ...
     */
    public com.google.cloud.automl.v1.ImageInputConfigOrBuilder getImageInputConfigOrBuilder() {
      if ((dataCase_ == 7) && (imageInputConfigBuilder_ != null)) {
        return imageInputConfigBuilder_.getMessageOrBuilder();
      } else {
        if (dataCase_ == 7) {
          return (com.google.cloud.automl.v1.ImageInputConfig) data_;
        }
    ...
    private com.google.protobuf.SingleFieldBuilderV3<
            ...
            com.google.cloud.automl.v1.ImageInputConfig.Builder,
            com.google.cloud.automl.v1.ImageInputConfigOrBuilder>
        getImageInputConfigFieldBuilder() {
      if (imageInputConfigBuilder_ == null) {
        if (!(dataCase_ == 7)) {
          data_ = com.google.cloud.automl.v1.ImageInputConfig.getDefaultInstance();
        }
      ...
      onChanged();
      ;
      return imageInputConfigBuilder_;
    }
